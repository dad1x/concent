...
if __name__ == '__main__':
    try:
        ...
        from concent_api.settings.e2e_tests_settings_template import ADDITIONAL_VERIFICATION_TIME_MULTIPLIER
        from concent_api.settings.e2e_tests_settings_template import BLENDER_THREADS
